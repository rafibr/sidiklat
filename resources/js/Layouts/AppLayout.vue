<template>
  <div class="min-h-screen p-2 sm:p-4 md:p-6 lg:p-8" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
    <div class="max-w-7xl mx-auto">
      <!-- Header -->
      <div class="bg-white/95 backdrop-blur-sm p-3 sm:p-4 md:p-6 rounded-lg md:rounded-xl shadow-xl mb-3 md:mb-6 text-center">
      ...
      <div class="bg-white/95 backdrop-blur-sm p-1 sm:p-2 rounded-lg shadow-lg mb-3 md:mb-6 overflow-x-auto">
        <div class="flex gap-1 sm:gap-2 justify-start sm:justify-center min-w-max sm:min-w-0 px-2 sm:px-0">
          ...
          <Link
            :href="route('pelatihan.comparison')"
            class="tab-button px-3 sm:px-4 py-2 rounded-lg font-semibold text-xs sm:text-sm whitespace-nowrap flex-shrink-0"
      ...
      <!-- Content -->
      <div class="bg-white/95 backdrop-blur-sm rounded-lg md:rounded-xl shadow-xl min-h-[400px] sm:min-h-[500px] md:min-h-[600px]">
        <slot />
      </div>
    </div>
