    ...
    <AppLayout>
        <div class="p-3 sm:p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 mb-6 md:mb-8">
                <div
                    class="bg-gradient-to-r from-blue-500 to-blue-600 p-4 md:p-6 rounded-xl text-white border-compact card-compact">
                ...
                <div
                    class="bg-gradient-to-r from-purple-500 to-purple-600 p-4 md:p-6 rounded-xl text-white border-compact card-compact">
                    <div class="flex items-center justify-between">
                        <div>
                ...
                <div
                    class="bg-gradient-to-r from-green-500 to-green-600 p-4 md:p-6 rounded-xl text-white border-compact card-compact">
                    <div class="flex items-center justify-between">
                        <div>
    ...
    methods: {
        ...
        async initCharts() {
            ...
            try {
                ...
                // Initialize comparison chart only when data exists
                if (this.hasComparisonData && this.$refs.comparisonChart) {
                ...
                // Initialize trend chart only when data exists
                if (this.hasMonthlyData && this.$refs.trendChart) {
                ...
                // Silently fail and log for debugging
